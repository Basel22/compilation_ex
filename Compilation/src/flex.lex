...
void throwIllegalException(String msg, int line) throws IllegalException {
	throw new IllegalException(msg, line);
}
...
{OPEN_STRING} 			{ throwIllegalException("Open string!", yyline+1); }
{COMMENT_ERROR} 		{ throwIllegalException("Open comment!", yyline+1); }
{ZERO_FIRST_INTEGER}	{ throwIllegalException("Number with a leading zero!", yyline+1); }